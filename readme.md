...
1\.3.3. Користувачі мають можливість програмувати та виконувати обчислення на емульованих старих комп'ютерах, що дозволяє їм глибше поринути в історію розвитку інформаційних технологій. 
